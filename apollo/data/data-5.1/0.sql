        ...
        and (EXISTS (
          select  
            ...
            where (((EXISTS (
              ...
              or (EXISTS (
                select  
                    (select created_at from test_bd.comments limit 1 offset 11)
                       as c0
                  from 
