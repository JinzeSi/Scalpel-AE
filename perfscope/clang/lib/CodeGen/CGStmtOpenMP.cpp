...
void CodeGenFunction::EmitOMPDataLayoutDirective(
    const OMPDataLayoutDirective &S) {
  CGOpenMPRuntime::DataLayoutInfo Info(/*RequiresDevicePointerInfo=*/true);
  ...
  // Emit region code.
  CGM.getOpenMPRuntime().emitDataLayoutCalls(*this, S, IfCond, Device, RCG,
                                             Info);
}
...
void CodeGenFunction::EmitOMPTargetEnterDataDirective(
  ...
  CGM.getOpenMPRuntime().emitDataLayoutStandAloneCall(*this, S, IfCond, Device);
}
