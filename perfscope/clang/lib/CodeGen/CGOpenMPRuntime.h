...
public:
  ...
  public:
    ...
    explicit DataLayoutInfo() {}
    explicit DataLayoutInfo(bool RequiresDevicePointerInfo)
  ...
  virtual void emitDataLayoutCalls(CodeGenFunction &CGF,
                                   const OMPExecutableDirective &D,
  ...
  /// \param Device Expression evaluated in device clause associated with the
  /// target directive, or null if no device clause is used.
  virtual void emitDataLayoutStandAloneCall(CodeGenFunction &CGF,
                                            const OMPExecutableDirective &D,
                                            const Expr *IfCond,
                                            const Expr *Device);
...
public:
  ...
  /// \param Info A record used to store information that needs to be preserved
  /// until the region is closed.
  void emitDataLayoutCalls(CodeGenFunction &CGF,
                           const OMPExecutableDirective &D, const Expr *IfCond,
                           const Expr *Device, const RegionCodeGenTy &CodeGen,
                           DataLayoutInfo &Info) override;
  ...
  /// \param Device Expression evaluated in device clause associated with the
  /// target directive, or null if no device clause is used.
  void emitDataLayoutStandAloneCall(CodeGenFunction &CGF,
                                    const OMPExecutableDirective &D,
                                    const Expr *IfCond,
