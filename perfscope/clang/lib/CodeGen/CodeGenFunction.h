...
public:
  ...
  struct OMPDataLayoutInfo {
    Address BasePointersArray = Address::invalid();
    Address PointersArray = Address::invalid();
    Address SizesArray = Address::invalid();
    unsigned NumberOfTargetItems = 0;
    explicit OMPDataLayoutInfo() = default;
    OMPDataLayoutInfo(Address BasePointersArray, Address PointersArray,
  ...
  void EmitOMPDataLayoutDirective(const OMPDataLayoutDirective &S);
