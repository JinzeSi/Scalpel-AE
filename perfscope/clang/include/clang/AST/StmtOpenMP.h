...
/// section 'b[:]'.
///
class OMPDataLayoutDirective : public OMPExecutableDirective {
  friend class ASTStmtReader;
  /// Build directive with the given start and end location.
  ///
  /// \param StartLoc Starting location of the directive kind.
  ...
  ///
  OMPDataLayoutDirective(SourceLocation StartLoc, SourceLocation EndLoc,
                         unsigned NumClauses)
      : OMPExecutableDirective(this, OMPDataLayoutDirectiveClass,
  ...
  /// \param NumClauses Number of clauses.
  ///
  explicit OMPDataLayoutDirective(unsigned NumClauses)
      : OMPExecutableDirective(this, OMPDataLayoutDirectiveClass,
...
public:
  ...
  ///
  static OMPDataLayoutDirective *CreateEmpty(const ASTContext &C, unsigned N,
                                             EmptyShell);

  static bool classof(const Stmt *T) {
    return T->getStmtClass() == OMPDataLayoutDirectiveClass;
  }
};
