...
public:
  ...
  void VisitOMPDataLayoutDirective(const OMPDataLayoutDirective *D);
...
void EnqueueVisitor::VisitOMPDataLayoutDirective(const 
                                                 OMPDataLayoutDirective *D) {
  VisitOMPExecutableDirective(D);
}
...
CXString clang_getCursorKindSpelling(enum CXCursorKind Kind) {
  ...
  case CXCursor_OMPDataLayoutDirective:
    return cxstring::createRef("OMPDataLayoutDirective");
