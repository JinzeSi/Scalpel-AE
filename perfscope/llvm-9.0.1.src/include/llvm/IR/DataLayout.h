//===- llvm/IR/DataLayout.h - Data size & alignment info -----------*- C++ -*-===//
//
...
// decl.
using LLVMDataLayoutRef = struct LLVMOpaqueDataLayout *;
...
inline DataLayout *unwrap(LLVMDataLayoutRef P) {
  return reinterpret_cast<DataLayout *>(P);
}

inline LLVMDataLayoutRef wrap(const DataLayout *P) {
  return reinterpret_cast<LLVMDataLayoutRef>(const_cast<DataLayout *>(P));
}
