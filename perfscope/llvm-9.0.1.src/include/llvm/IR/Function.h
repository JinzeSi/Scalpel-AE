//===- llvm/IR/Function.h - Class to represent a single function ---*- C++ -*-===//
//
...
public:
  ...
  /// defined in llvm/IR/Intrinsics.h.
  ...
  /// in llvm/IR/Intrinsics.h.  Sets the intrinsic ID to Intrinsic::not_intrinsic
