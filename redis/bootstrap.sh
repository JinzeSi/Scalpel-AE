#!/bin/bash
#
# This file was automatically generated by s2e-env at 2024-12-17 02:34:59.816404
#
...
function execute_target {
    ...
    # redis-server is dynamically linked, so s2e.so has been preloaded to
...
${S2ECMD} get "redis-server"
${S2ECMD} get "redis-cli"
${S2ECMD} get "dump.rdb"
${S2ECMD} get "panda.so"
${S2ECMD} get "nodes.conf"
${S2ECMD} get "redis.conf"
...
# Run the analysis
    ...
    TARGET_PATH='./redis-server'


prepare_target "${TARGET_PATH}"
prepare_target "./redis-cli"
prepare_target "./panda.so"
sleep 3




while ! grep -q "Ready to accept connections tcp" /tmp/redis.log; do
