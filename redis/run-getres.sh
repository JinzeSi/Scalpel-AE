...
cat real-execute-res-old.txt | grep "modified part" > real-execute-res-old-1.txt
cat real-execute-res.txt | grep "modified part" > real-execute-res-1.txt

cat real-execute-res-pure.txt | grep "modified part" > real-execute-res-pure-1.txt
