...
std::map<std::string, std::string> map5;
            ...
            if(setKey.find(tmp) != setKey.end() ){
                ...
                if(setValue.empty()){
                    ...
                    for(const auto& element : setValue) {
                        int tmpMaxPriority = mapPriority[map5[element]];
                        if(tmpMaxPriority > MaxPriority){
                            MaxPriority = tmpMaxPriority;
                            MaxElement = map5[element];
                        }  
                        // std::cout <<  "element1:" <<element << " " <<mapPriority[map5[element]] <<" " << map5[element] <<std::endl;
                    }
        ...
        if(setValue.empty()){
            ...
            if(res3Tmp2.empty()){
                ...
                for(const auto& element : setValue) {
                    ...
                    // std::cout <<  "element2:" <<element << " " <<mapPriority[map5[element]] <<" " << map5[element] <<std::endl;
                ...
                for(const auto& element : setValue) {
                    ...
                    // std::cout <<  "element3:" <<element << " " <<mapPriority[map5[element]] <<" " << map5[element] <<std::endl;
...
int main(int argc, char *argv[]) {
    ...
    std::ifstream infile8(filename4);
    std::string line;
    ...
    while (std::getline(infile8, line)) {
        ...
        map5[numKey] = instruction;
        // std::cout << numKey << " instruction:" <<map5[numKey] <<std::endl;
