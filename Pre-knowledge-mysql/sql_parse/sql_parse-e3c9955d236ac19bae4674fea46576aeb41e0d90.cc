...
*/
extern "C" { void begin_trace();void end_trace();}
void dispatch_sql_command(THD *thd, Parser_state *parser_state) { if( thd->query().str != "shutdown") begin_trace();
  DBUG_TRACE;
  ...
  DEBUG_SYNC(thd, "query_rewritten");end_trace();
}
